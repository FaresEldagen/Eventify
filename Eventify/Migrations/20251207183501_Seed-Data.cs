        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProofOfOwnership = table.Column<string>(type: "VARCHAR(250)", maxLength: 250, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, 2, "القاهرة - مصر", "محمود سمير عبد الله", "Venue owner with a passion for hosting memorable experiences. With more than 5 years in the industry, I provide versatile spaces tailored for events of all kinds, ensuring clients and guests enjoy smooth and successful gatherings.", "/Images/back1.jpg", "a2725a7f-7db1-4a35-a5c2-07a05ad7faa2", 1, "Owner1@test.com", true, "/Images/front1.jpg", 1, new DateTime(2021, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, "29701020123455", "OWNER1@TEST.COM", "MAHMOUD", "AQAAAAIAAYagAAAAEI7GzgzO60X0bn5KTiWd1yb7OIp25rG8U3uWQhhDqYPjWmOu9K0jaUxYv8lctdklGA==", null, false, "/Images/avatar.jpg", "F2821D12 - 02EC - 4EB6 - 88A7 - 393BBAAD4D54", false, "Mahmoud", "Owner", 4, 15000.75m },
                    { 2, 0, 2, "القاهرة - مصر", "محمود سمير عبد الله", "Venue owner with a passion for hosting memorable experiences. With more than 5 years in the industry, I provide versatile spaces tailored for events of all kinds, ensuring clients and guests enjoy smooth and successful gatherings.", "/Images/back1.jpg", "5cb78575-50a4-4c4c-8bdc-92eea1fd17b3", 1, "Owner2@test.com", true, "/Images/front1.jpg", 1, new DateTime(2021, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, "29701020123455", "OWNER2@TEST.COM", "ALI", "AQAAAAIAAYagAAAAEF4UIQ7Ju8Sk1160ltKKrtcHZzNqng9HKUC89aUp/q/zNd+oxenvg9Hp29rvXPu3eA==", null, false, "/Images/avatar.jpg", "F2821D12 - 02EC - 4EB6 - 88A7 - 393BBAAD4D54", false, "Ali", "Owner", 3, 15000.75m },
                    { 3, 0, 2, "القاهرة - مصر", "محمود سمير عبد الله", "Venue owner with a passion for hosting memorable experiences. With more than 5 years in the industry, I provide versatile spaces tailored for events of all kinds, ensuring clients and guests enjoy smooth and successful gatherings.", "/Images/back1.jpg", "31f18da7-bc4e-4265-97c3-d13148aefe0c", 1, "Owner3@test.com", true, "/Images/front1.jpg", 1, new DateTime(2021, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, "29701020123455", "OWNER3@TEST.COM", "AMR", "AQAAAAIAAYagAAAAEPtuF+uaogcNLCl2q7+Lq0yV77q/w0vgHuerb/IAPv4TkBTfUmNrOgUytAiK2xy9fQ==", null, false, "/Images/avatar.jpg", "F2821D12 - 02EC - 4EB6 - 88A7 - 393BBAAD4D54", false, "Amr", "Owner", 3, 15000.75m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 4, 0, 2, "القاهرة - مصر", "فارس حسن علي الداجن", "Event Organizer passionate about designing and managing unforgettable events. With over 5 years in the industry, I specialize in bringing ideas to life, coordinating every detail, and creating seamless experiences for attendees.", "/Images/back1.jpg", "cd49e7a9-a129-49b1-8ae5-e9d6250c30c2", 1, "Organizer1@test.com", true, 5, "/Images/front1.jpg", 1, new DateTime(2022, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, "29801150123456", "ORGANIZER1@TEST.COM", "FARES", "AQAAAAIAAYagAAAAEJ13JVXnH14ekNtuYNMO56qiINz8qdA8t3Iyibevp+tzEsRY/fTcwkKfCUCZmVJ2yQ==", 4, null, false, "/Images/avatar.jpg", "F2821D12 - 02EC - 4EB6 - 88A7 - 393BBAAD4D54", "Tech Events", false, "Fares", "Organizier" },
                    { 5, 0, 2, "القاهرة - مصر", "فارس حسن علي الداجن", "Event Organizer passionate about designing and managing unforgettable events. With over 5 years in the industry, I specialize in bringing ideas to life, coordinating every detail, and creating seamless experiences for attendees.", "/Images/back1.jpg", "b6dbb47a-09ef-4750-92cd-dd933a46857d", 1, "Organizer2@test.com", true, 5, "/Images/front1.jpg", 1, new DateTime(2022, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, "29801150123456", "ORGANIZER2@TEST.COM", "AHMED", "AQAAAAIAAYagAAAAENT3HKTB/QGuU0K089I0Veg7ptB2BTgrRZSC1pgiYT4kCwfxTVbSY0ZT5YP8y9POdg==", 1, null, false, "/Images/avatar.jpg", "F2821D12 - 02EC - 4EB6 - 88A7 - 393BBAAD4D54", "Tech Events", false, "Ahmed", "Organizier" },
                    { 6, 0, 2, "القاهرة - مصر", "فارس حسن علي الداجن", "Event Organizer passionate about designing and managing unforgettable events. With over 5 years in the industry, I specialize in bringing ideas to life, coordinating every detail, and creating seamless experiences for attendees.", "/Images/back1.jpg", "e7c6ca42-dc41-448b-9d21-293a9a9bb2d3", 1, "Organizer3@test.com", true, 5, "/Images/front1.jpg", 1, new DateTime(2022, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, "29801150123456", "ORGANIZER3@TEST.COM", "ZIAD", "AQAAAAIAAYagAAAAEMHRu/G+tCu+oGoHFbrCXY/gp4W7r2q+MGUqVtnlj2HYpbOOgKF5bivx/JNS76KlMQ==", 2, null, false, "/Images/avatar.jpg", "F2821D12 - 02EC - 4EB6 - 88A7 - 393BBAAD4D54", "Tech Events", false, "Ziad", "Organizier" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 7, 0, 2, null, null, null, null, "fcaf4690-a743-4df3-91b6-4b89737c4240", null, "Admin1@test.com", true, null, null, new DateTime(2022, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, null, "ADMIN1@TEST.COM", "MOHAMED", "AQAAAAIAAYagAAAAEGIPmxXwjJPf25j0AWDxjNovxWNM0vsKWtnQZ5ISFUjfrcUOxlFnKae/vqbpSV86JQ==", null, false, null, "F2821D12 - 02EC - 4EB6 - 88A7 - 393BBAAD4D54", false, "Mohamed", "Admin" },
                    { 8, 0, 2, null, null, null, null, "021911e9-7ee6-45d9-a256-bf5c943b4223", null, "Admin2@test.com", true, null, null, new DateTime(2022, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, null, "ADMIN2@TEST.COM", "AABAS", "AQAAAAIAAYagAAAAEMlPX810P4J+KVpbSG9QrE6o5lTwOeYUAIIHiGsiAQ6ygYcaBlGd3dOFfOhP0Jsocw==", null, false, null, "F2821D12 - 02EC - 4EB6 - 88A7 - 393BBAAD4D54", false, "Aabas", "Admin" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 9, 0, 3, "القاهرة - مصر", "فارس حسن علي الداجن", "Event Organizer passionate about designing and managing unforgettable events. With over 5 years in the industry, I specialize in bringing ideas to life, coordinating every detail, and creating seamless experiences for attendees.", "/Images/back1.jpg", "79fc4b50-0330-4d0a-b313-cecbcc5eda73", 10, "Organizer4@test.com", true, 5, "/Images/front1.jpg", 1, new DateTime(2022, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, "29801150123456", "ORGANIZER4@TEST.COM", "ASHRAF", "AQAAAAIAAYagAAAAEEvR5yiZre0yepCo0vZHKL0KjTyPi/RZ+6CSulZEhFhpGdfxpaeQL5wniHQUElXU6w==", 0, null, false, "/Images/avatar.jpg", "F2821D12 - 02EC - 4EB6 - 88A7 - 393BBAAD4D54", "Tech Events", false, "Ashraf", "Organizier" },
                    { 10, 0, 1, "القاهرة - مصر", "فارس حسن علي الداجن", "Event Organizer passionate about designing and managing unforgettable events. With over 5 years in the industry, I specialize in bringing ideas to life, coordinating every detail, and creating seamless experiences for attendees.", "/Images/back1.jpg", "af61d66b-159f-477e-bb6e-8ab2f1e6eead", 3, "Organizer5@test.com", true, 5, "/Images/front1.jpg", 1, new DateTime(2022, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, "29801150123456", "ORGANIZER5@TEST.COM", "ZAATR", "AQAAAAIAAYagAAAAECY2kGU1vcNuxLEJiYiGPJGOT/ZiA+WYZOthaEodlu6HF9ghFUzjfUL20Tt6Uf4GiQ==", 0, null, false, "/Images/avatar.jpg", "F2821D12 - 02EC - 4EB6 - 88A7 - 393BBAAD4D54", "Tech Events", false, "Zaatr", "Organizier" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 11, 0, 1, "القاهرة - مصر", "محمود سمير عبد الله", "Venue owner with a passion for hosting memorable experiences. With more than 5 years in the industry, I provide versatile spaces tailored for events of all kinds, ensuring clients and guests enjoy smooth and successful gatherings.", "/Images/back1.jpg", "f54a0410-35c5-4f31-9932-f5b59dd37f4a", 1, "Owner4@test.com", true, "/Images/front1.jpg", 1, new DateTime(2021, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, "29701020123455", "OWNER4@TEST.COM", "RAMI", "AQAAAAIAAYagAAAAEGS3a/9Q1wGpqpidnmiu5eeai/a4kp+PUfaqILAW6Gb43FzG6X2DyTAHmVgeTKSzng==", null, false, "/Images/avatar.jpg", "F2821D12 - 02EC - 4EB6 - 88A7 - 393BBAAD4D54", false, "Rami", "Owner", 0, 15000.75m },
                    { 12, 0, 3, "القاهرة - مصر", "محمود سمير عبد الله", "Venue owner with a passion for hosting memorable experiences. With more than 5 years in the industry, I provide versatile spaces tailored for events of all kinds, ensuring clients and guests enjoy smooth and successful gatherings.", "/Images/back1.jpg", "17b2406c-6ff6-4cc9-8f36-e4e116abff75", 2, "Owner5@test.com", true, "/Images/front1.jpg", 1, new DateTime(2021, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, "29701020123455", "OWNER5@TEST.COM", "ANAS", "AQAAAAIAAYagAAAAECfUS6ZWm/S5E8sb0oAouYs5sCbCWpfrch+qJEDEGyaUS6iVHW2mIqcJM+tkbBUxQg==", null, false, "/Images/avatar.jpg", "F2821D12 - 02EC - 4EB6 - 88A7 - 393BBAAD4D54", false, "Anas", "Owner", 0, 15000.75m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 5, "Pyramids Road", 700, 3, "A meetup focusing on ancient Egyptian culture.", new DateTime(2025, 3, 5, 18, 0, 0, 0, DateTimeKind.Unspecified), "Giza Cultural Meetup", 2, "Guided Tour, Cultural Talks", true, 4, new DateTime(2025, 3, 5, 14, 0, 0, 0, DateTimeKind.Unspecified), 3, 250m, 5 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "/images/venue1_1.jpg", 11 },
                    { "/images/venue1_1.jpg", 12 },
                    ...
                    { "/images/venue1_2.jpg", 11 },
                    { "/images/venue1_2.jpg", 12 },
                    ...
                    { "/images/venue1_3.jpg", 11 },
                    { "/images/venue1_3.jpg", 12 },
                    ...
                    { "/images/venue1_4.jpg", 11 },
                    { "/images/venue1_4.jpg", 12 }
                });
