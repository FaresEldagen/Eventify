    ...
    public partial class SeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, "القاهرة - مصر", "محمود سمير عبد الله", "Venue owner with a passion for hosting memorable experiences. With more than 5 years in the industry, I provide versatile spaces tailored for events of all kinds, ensuring clients and guests enjoy smooth and successful gatherings.", "~/image/back1.jpg", "e37c22cd-7079-476b-ae05-2d69222ec3c7", 1, "Owner1@test.com", true, "~/image/front1.jpg", 1, new DateTime(2021, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, "29701020123455", "OWNER1@TEST.COM", "MAHMOUD", "AQAAAAIAAYagAAAAEAQzp05DOktVDbaYbD55f5NXuEleGVIFUl7mKY38wERp08tLrILxWVKATBSUNIhyFA==", null, false, "~/image/avatar.jpg", "F2821D12 - 02EC - 4EB6 - 88A7 - 393BBAAD4D54", false, "Mahmoud", "Owner", 3, 15000.75m },
                    { 2, 0, "القاهرة - مصر", "محمود سمير عبد الله", "Venue owner with a passion for hosting memorable experiences. With more than 5 years in the industry, I provide versatile spaces tailored for events of all kinds, ensuring clients and guests enjoy smooth and successful gatherings.", "~/image/back1.jpg", "1b5d1f54-88ee-4b6f-ba29-59c856bc5a0e", 1, "Owner2@test.com", true, "~/image/front1.jpg", 1, new DateTime(2021, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, "29701020123455", "OWNER2@TEST.COM", "ALI", "AQAAAAIAAYagAAAAEFRlrVahlgfAY0cglOuTo96YWURFtcPDPlCiw+3p19kz8qDVtN8iWYfiaW4CtcYhsw==", null, false, "~/image/avatar.jpg", "F2821D12 - 02EC - 4EB6 - 88A7 - 393BBAAD4D54", false, "Ali", "Owner", 3, 15000.75m },
                    { 3, 0, "القاهرة - مصر", "محمود سمير عبد الله", "Venue owner with a passion for hosting memorable experiences. With more than 5 years in the industry, I provide versatile spaces tailored for events of all kinds, ensuring clients and guests enjoy smooth and successful gatherings.", "~/image/back1.jpg", "93a72970-87aa-4a72-8867-acd0286d4ef2", 1, "Owner3@test.com", true, "~/image/front1.jpg", 1, new DateTime(2021, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, "29701020123455", "OWNER3@TEST.COM", "AMR", "AQAAAAIAAYagAAAAEFrloBbbP/YLkJ6OpjGueKS0gsJb6Gc34xhDdi/fkvqEyWMI7YBv3MZcq/Y3qSX2nw==", null, false, "~/image/avatar.jpg", "F2821D12 - 02EC - 4EB6 - 88A7 - 393BBAAD4D54", false, "Amr", "Owner", 3, 15000.75m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 4, 0, "القاهرة - مصر", "فارس حسن علي الداجن", "Event Organizer passionate about designing and managing unforgettable events. With over 5 years in the industry, I specialize in bringing ideas to life, coordinating every detail, and creating seamless experiences for attendees.", "~/image/back1.jpg", "cf66b0b2-2d1a-4bf1-86bb-1817fe524727", 1, "Organizer1@test.com", true, 5, "~/image/front1.jpg", 1, new DateTime(2022, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, "29801150123456", "ORGANIZER1@TEST.COM", "FARES", "AQAAAAIAAYagAAAAEPYyfCpxGeYnawk5hrBsXzdPOff7EPcVEOAT7qrSk1TicLONtc5X/vySSp15zlI3hw==", 12, null, false, "~/image/avatar.jpg", "F2821D12 - 02EC - 4EB6 - 88A7 - 393BBAAD4D54", "Tech Events", false, "Fares", "Organizier" },
                    { 5, 0, "القاهرة - مصر", "فارس حسن علي الداجن", "Event Organizer passionate about designing and managing unforgettable events. With over 5 years in the industry, I specialize in bringing ideas to life, coordinating every detail, and creating seamless experiences for attendees.", "~/image/back1.jpg", "2f786027-48c7-4593-99b4-7adc81ab9cce", 1, "Organizer2@test.com", true, 5, "~/image/front1.jpg", 1, new DateTime(2022, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, "29801150123456", "ORGANIZER2@TEST.COM", "AHMED", "AQAAAAIAAYagAAAAEKO2R1dnYGM50ah8kvp1rSqmBtTx4Bn5Mau9Ux+ggbEBnI4pJJTbpgpTNu5RO6IckQ==", 12, null, false, "~/image/avatar.jpg", "F2821D12 - 02EC - 4EB6 - 88A7 - 393BBAAD4D54", "Tech Events", false, "Ahmed", "Organizier" },
                    { 6, 0, "القاهرة - مصر", "فارس حسن علي الداجن", "Event Organizer passionate about designing and managing unforgettable events. With over 5 years in the industry, I specialize in bringing ideas to life, coordinating every detail, and creating seamless experiences for attendees.", "~/image/back1.jpg", "14e1bc56-0523-43ae-a5a6-47e7b3ce01ff", 1, "Organizer3@test.com", true, 5, "~/image/front1.jpg", 1, new DateTime(2022, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, "29801150123456", "ORGANIZER3@TEST.COM", "ZIAD", "AQAAAAIAAYagAAAAEIMMV83KmMm6pasSZvHqrDGqVS+iNzo++/Er1dq5yzmIN1py2DXjWZTex4EOGkTQUg==", 12, null, false, "~/image/avatar.jpg", "F2821D12 - 02EC - 4EB6 - 88A7 - 393BBAAD4D54", "Tech Events", false, "Ziad", "Organizier" }
                });
