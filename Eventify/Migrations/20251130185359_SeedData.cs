    ...
    public partial class SeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, "القاهرة - مصر", "محمود سمير عبد الله", "Venue owner with a passion for hosting memorable experiences. With more than 5 years in the industry, I provide versatile spaces tailored for events of all kinds, ensuring clients and guests enjoy smooth and successful gatherings.", "/Images/back1.jpg", "4198f3dc-28b6-46a9-a068-3646f4a13fff", 1, "Owner1@test.com", true, "/Images/front1.jpg", 1, new DateTime(2021, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, "29701020123455", "OWNER1@TEST.COM", "MAHMOUD", "AQAAAAIAAYagAAAAEOcVQPgEVaePg/iVYDBo7IdzIyKdVmWQLdZ3YsaD5vrYKpxeuDI8MOCcelvPxMUSHw==", null, false, "/Images/avatar.jpg", "F2821D12 - 02EC - 4EB6 - 88A7 - 393BBAAD4D54", false, "Mahmoud", "Owner", 3, 15000.75m },
                    { 2, 0, "القاهرة - مصر", "محمود سمير عبد الله", "Venue owner with a passion for hosting memorable experiences. With more than 5 years in the industry, I provide versatile spaces tailored for events of all kinds, ensuring clients and guests enjoy smooth and successful gatherings.", "/Images/back1.jpg", "7caca728-195f-4bb2-811c-faea09049ed6", 1, "Owner2@test.com", true, "/Images/front1.jpg", 1, new DateTime(2021, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, "29701020123455", "OWNER2@TEST.COM", "ALI", "AQAAAAIAAYagAAAAEPUHvMgLli5Pt+2bCSb7jq9si4XGZqh1RQAIxuyDB/jjO4u9MCl71MrgPemk4bockA==", null, false, "/Images/avatar.jpg", "F2821D12 - 02EC - 4EB6 - 88A7 - 393BBAAD4D54", false, "Ali", "Owner", 3, 15000.75m },
                    { 3, 0, "القاهرة - مصر", "محمود سمير عبد الله", "Venue owner with a passion for hosting memorable experiences. With more than 5 years in the industry, I provide versatile spaces tailored for events of all kinds, ensuring clients and guests enjoy smooth and successful gatherings.", "/Images/back1.jpg", "3c5f8bb8-a612-4715-9065-0110b211a0d8", 1, "Owner3@test.com", true, "/Images/front1.jpg", 1, new DateTime(2021, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, "29701020123455", "OWNER3@TEST.COM", "AMR", "AQAAAAIAAYagAAAAEKxsW0uWdxAxXWT4AvpfCReOCD5WmENUQwpb+zmUnsTP79UFwwpre6+tWC+xmfvNLQ==", null, false, "/Images/avatar.jpg", "F2821D12 - 02EC - 4EB6 - 88A7 - 393BBAAD4D54", false, "Amr", "Owner", 3, 15000.75m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 4, 0, "القاهرة - مصر", "فارس حسن علي الداجن", "Event Organizer passionate about designing and managing unforgettable events. With over 5 years in the industry, I specialize in bringing ideas to life, coordinating every detail, and creating seamless experiences for attendees.", "/Images/back1.jpg", "ff9c6550-3e5f-42ce-8c17-59c789585816", 1, "Organizer1@test.com", true, 5, "/Images/front1.jpg", 1, new DateTime(2022, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, "29801150123456", "ORGANIZER1@TEST.COM", "FARES", "AQAAAAIAAYagAAAAEBWXIHv3QjqrQ2oTxyv359fZyA/YPNsMzjvJ2EZrgnLgnvbidaNOu0A+1+bSWchY1w==", 12, null, false, "/Images/avatar.jpg", "F2821D12 - 02EC - 4EB6 - 88A7 - 393BBAAD4D54", "Tech Events", false, "Fares", "Organizier" },
                    { 5, 0, "القاهرة - مصر", "فارس حسن علي الداجن", "Event Organizer passionate about designing and managing unforgettable events. With over 5 years in the industry, I specialize in bringing ideas to life, coordinating every detail, and creating seamless experiences for attendees.", "/Images/back1.jpg", "a0fabe54-e852-4738-9506-a354dcec2b06", 1, "Organizer2@test.com", true, 5, "/Images/front1.jpg", 1, new DateTime(2022, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, "29801150123456", "ORGANIZER2@TEST.COM", "AHMED", "AQAAAAIAAYagAAAAEFyJ02iUYAYl4LIcb2mDZehsNxRK9DJu46imTcJKebvhlwSqbQNI90FBO5YxoPPMbA==", 12, null, false, "/Images/avatar.jpg", "F2821D12 - 02EC - 4EB6 - 88A7 - 393BBAAD4D54", "Tech Events", false, "Ahmed", "Organizier" },
                    { 6, 0, "القاهرة - مصر", "فارس حسن علي الداجن", "Event Organizer passionate about designing and managing unforgettable events. With over 5 years in the industry, I specialize in bringing ideas to life, coordinating every detail, and creating seamless experiences for attendees.", "/Images/back1.jpg", "7640063f-68bf-44f4-a286-584881d1491a", 1, "Organizer3@test.com", true, 5, "/Images/front1.jpg", 1, new DateTime(2022, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, "29801150123456", "ORGANIZER3@TEST.COM", "ZIAD", "AQAAAAIAAYagAAAAELOvAN0U/s0YvCi2nYvt0nx3cFPbaux7/3PwCFXa1dG5VqawQhGOjgfFXjvAHj5ynw==", 12, null, false, "/Images/avatar.jpg", "F2821D12 - 02EC - 4EB6 - 88A7 - 393BBAAD4D54", "Tech Events", false, "Ziad", "Organizier" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Cairo Grand Hall, Nasr City", null, 1, "A conference discussing the future of AI and technology.", new DateTime(2025, 4, 12, 18, 0, 0, 0, DateTimeKind.Unspecified), "Tech Innovations Conference 2025", "Speakers, Workshops, Networking", false, 4, new DateTime(2025, 4, 12, 10, 0, 0, 0, DateTimeKind.Unspecified), 2, 500m, 1 },
